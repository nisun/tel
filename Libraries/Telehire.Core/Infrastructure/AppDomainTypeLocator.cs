...
namespace Telehire.Core.Infrastructure
{
    public class AppDomainTypeLocator : ITypeLocator
    {
        ...
        /// <summary>Gets or sets wether it should iterate assemblies in the app domain when loading it types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that it assemblies arn't investigated (e.g. by not including something like "^it|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the it factory.</returns>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into it.
        /// </returns>
