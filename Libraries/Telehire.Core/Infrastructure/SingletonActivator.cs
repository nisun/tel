...
namespace Telehire.Core.Infrastructure
{
    ...
    public class SingletonActivator<T> : Singleton
    {
        static T instance;
    ...
    public class SingletonList<T> : SingletonActivator<IList<T>>
    {
        static SingletonList()
        {
            SingletonActivator<IList<T>>.Instance = new List<T>();
        }
        ...
        {
            get { return SingletonActivator<IList<T>>.Instance; }
        }
    }
    ...
    public class SingletonDictionary<TKey, TValue> : SingletonActivator<IDictionary<TKey, TValue>>
    {
        static SingletonDictionary()
        {
            SingletonActivator<Dictionary<TKey, TValue>>.Instance = new Dictionary<TKey, TValue>();
        }
        ...
        {
            get { return SingletonActivator<Dictionary<TKey, TValue>>.Instance; }
        }
    }
