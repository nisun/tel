...
using Telehire.Core.ComponentModel;
using Telehire.Core.Helpers;


[assembly: PreApplicationStartMethod(typeof(Telehire.Core.Plugins.PluginManager), "Initialize")]
namespace Telehire.Core.Plugins
{
    ...
    //http://www.codeproject.com/Articles/614767/NET-ASP-NET-MVC-plug-in-architecture-with-embedded
        ...
        private static Assembly PerformFileDeploy(FileInfo plug)
        {
            if (plug.Directory.Parent == null)
                throw new InvalidOperationException("The plugin directory for the " + plug.Name +
                                                    " file exists in a folder outside of the allowed deployment folder heirarchy");
